...
<div class="top-nav" id="home" style="background-color: #38AAF2;">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-auto">
                <p> <i class='bx bxs-envelope'></i> <?php echo $CompanyEmailAddress ; ?></p>
                <p> <i class='bx bxs-phone-call'></i> <?php echo $CompanyTelephone1 ; ?></p>
            </div>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top" style="border-bottom: 0%;">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="./img/logo.png" alt="" srcset="" style="width: 90px;">
        <!--Nome da empresa com a ultima palavra em destaque-->
        <?php echo $PrimeiraParte . ' '; ?><span style="color: #38AAF2;">&nbsp;<?php echo $UltimaPalavra; ?></span>
    </a>
