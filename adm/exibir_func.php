                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $support)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="func_edit.php?id=<?= $support['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                                </td>
                                                <td> 
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_func" value="<?=$support['id'];?>" class="btn btn-danger btn-sm">Deletar</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
