    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="modal" data-bs-target="#exampleModal"  aria-hidden="true">Cadastro_Cliente</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="modal" data-bs-target="#exampleModal2"  aria-hidden="true">Cadastro_Funcionario</a>
                </li>
                <li class="nav-item">
                                                    ...
                                                    <div class="card-body" style="background-color: rgba(0, 0, 0, 0.6);color: white;border: 2px solid rgba(0, 0, 0, 0);border-radius: 3px;">
                                                        <form  action="code.php" method="post" style="text-align:center;">
                                                            ...
                                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                                <button  class="btn btn-primary submit" type="submit" name="save_func" style="margin: 10px;"> Enviar </button> 
                                                        </fieldset>
                                                    </form>
                                                </div> 
                                            </div>
