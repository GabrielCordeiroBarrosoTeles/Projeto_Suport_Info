                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Detalhes do cliente
                            <a data-bs-toggle="modal" data-bs-target="#exampleModal3" class="btn btn-primary float-end">Adicionar Cliente</a>
                        </h4>
                    </div>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $support)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="cliente-edit.php?id=<?= $support['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                                </td>
                                                <td> 
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_cliente" value="<?=$support['id'];?>" class="btn btn-danger btn-sm">Deletar</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
